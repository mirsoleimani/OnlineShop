...
{
    public class ProcessSearchShopByContactInfoAdvanced:IBusinessLogic
    {
        ...
        public void Invoke()
        {
            ShopSearchContactAdvancedSelectData selectData =
                new ShopSearchContactAdvancedSelectData();
