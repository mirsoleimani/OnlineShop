...
{
    public class ProcessSearchShopAddressInfoByCategoryID:IBusinessLogic
    {
        ...
        public void Invoke()
        {
            DataAccess.Shop.Select.Search.ShopAddressInfoByCategoryIDSearchData selectData =
                new OnlineShop.DataAccess.Shop.Select.Search.ShopAddressInfoByCategoryIDSearchData();
