<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AboutUsInfo.ascx.cs" Inherits="Admin_Modules_AboutUsInfo" %>
<table class="adminContent" border="0" cellspacing="0" cellpadding="0" width="100%"
    dir="rtl" >
    <tr>
        <td class="adminTitle">
            <asp:Label runat="Server" ID="lblGuideDescription" Text="توضيحات" ToolTip="توضيحات درباره ی ما"></asp:Label>
