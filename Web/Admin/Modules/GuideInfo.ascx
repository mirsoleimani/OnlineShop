<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GuideInfo.ascx.cs" Inherits="Admin_Modules_GuideInfo" %>
<table class="adminContent" border="0" cellspacing="0" cellpadding="0" width="100%"
    dir="rtl" >
    <tr>
        <td class="adminTitle">
            <asp:Label runat="Server" ID="lblGuideDescription" Text="توضيحات" ToolTip="توضيحات راهنما"></asp:Label>
